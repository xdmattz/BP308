...
main()
{
    ...
    // Note, this is the nominal offset of the DAC ouputs, I think it may be due to me using standard resistor
    // values, instead of exact values to make the true offest 0.
