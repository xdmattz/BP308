// ======================================================================
// TLAUX_Bootloader.v generated from TopDesign.cysch
// 03/12/2019 at 22:03
...
module USBFS_v3_20_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("62da6f9e-7369-464f-bbfc-1b7694d8261c/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("62da6f9e-7369-464f-bbfc-1b7694d8261c/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [7:0] tmpOE__Pins_Port3_net;
	wire [7:0] tmpFB_7__Pins_Port3_net;
	wire [7:0] tmpIO_7__Pins_Port3_net;
	wire [0:0] tmpINTERRUPT_0__Pins_Port3_net;
	electrical [0:0] tmpSIOVREF__Pins_Port3_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pins_Port3
		 (.oe(tmpOE__Pins_Port3_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Pins_Port3_net[7:0]}),
		  .io({tmpIO_7__Pins_Port3_net[7:0]}),
		  .siovref(tmpSIOVREF__Pins_Port3_net),
		  .interrupt({tmpINTERRUPT_0__Pins_Port3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pins_Port3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("04648236-f2e3-4acc-afb0-5dafb69001f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
